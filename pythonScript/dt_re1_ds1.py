...
# classifier = tree.DecisionTreeClassifier(criterion='entropy', max_depth=20,
#                                          max_features='auto', min_samples_leaf=1, min_samples_split=2, random_state=1)
# classifier = tree.DecisionTreeClassifier(max_depth=40, random_state=1)
...
count =0
file = open('Output/ds1Val-dt.csv', 'w')
