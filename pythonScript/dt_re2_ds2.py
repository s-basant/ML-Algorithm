...
#
# classifier = tree.DecisionTreeClassifier(criterion='entropy', max_depth=50,
#                                         max_features='auto', min_samples_leaf=1, min_samples_split=5, random_state=4)

# classifier = tree.DecisionTreeClassifier(criterion='entropy', max_depth=30,max_features='auto', min_samples_leaf=1,
...
count =0
file = open('Output/ds2Test-dt.csv', 'w')
