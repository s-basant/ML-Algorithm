...
# classifier = RandomForestClassifier(random_state=2,criterion= 'entropy',
#                                     max_depth=20, min_samples_leaf=1,n_estimators = 200,min_samples_split=5)
...
count =0
file = open('Output/ds2Val-3.csv', 'w')
